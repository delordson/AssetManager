...
<head>
    ...
    <title>Asset manager App - Log In</title>
    <style type="text/css">
        ...
        <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false">
            <LayoutTemplate>
                <div class="accountInfo">
                    <asp:Image ID="ApplicationLogo" runat="server" ImageUrl="~/ApplicationLogo.png" Height="220px" Width="220px" />
                    <h1>Asset Manager</h1>
                    <h2>Log In</h2>
                    ...
                    <div class="submit-login">
                        ...
                        <%--<a href="mailto:delordson@gmail.com">Send me an email for a demo account</a>--%>
